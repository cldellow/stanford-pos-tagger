...
CP=./:./postagger.jar:/usr/share/scala/lib/scala-library.jar

#-agentlib:hprof=file=c:/hprof.txt,cpu=times
#scalac -cp $CP Go.scala && java -agentlib:hprof=file=./hprof.txt,cpu=samples,interval=2 -cp $CP MyScalaApp
